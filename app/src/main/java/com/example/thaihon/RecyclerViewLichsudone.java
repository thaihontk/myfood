...
public class RecyclerViewLichsudone extends RecyclerView.Adapter<RecyclerViewLichsudone.RecyclerViewHolder> {
    ...
    public RecyclerViewLichsudone(Activity activity,List<String> url, List<String> idnguoidung, List<String> idmonan, List<String> ten, List<String> diachi, List<String> gia, List<String> ngaymua, List<String> hinhanh, List<String> trangthai) {
        this.url = url;
    ...
    @Override
    public RecyclerViewLichsudone.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_lichsudone, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewLichsudone.RecyclerViewHolder holder, final int position) {
